...
<body>
    <div class="navigation">
        <h2>Navigation</h2>
            ...
            <a href="alumniExperience.php" class="active">Alumni</a>
    ...
    <form method="post" action="">
        <div>
            ...
            <select id="domain" name="domain" required>
                ...
                <?php
                    ...
                    $sql = "select distinct job_role from alumni_experience";
        ...
        <div>
            ...
            <select id="company" name="company" required>
                ...
                $sql = "SELECT DISTINCT company_name FROM alumni_experience";
                $result = $conn->query($sql);
