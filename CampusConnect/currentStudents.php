        ...
        <div>
            ...
            <select id="domain" name="domain" required>
                ...
                <?php
                    ...
                    $sql = "select distinct Area_of_Interest from Student";
                    $result = $conn->query($sql);
                    while($row = $result->fetch_assoc()){
                        echo "<option value='".$row['Area_of_Interest']."'>".$row['Area_of_Interest']."</option>";
                    }
                ?>
            </select>
        </div>
        <div>
            ...
            <select id="branch" name="branch" required>
                ...
                <?php
                    ...
                    $sql = "select distinct Specialization from Student";
                    $result = $conn->query($sql);
                    while($row = $result->fetch_assoc()){
